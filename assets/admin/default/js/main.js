$(document).ready(function() {
	...
	$('.cardCancel').on('click', function(e) {
        e.preventDefault();
        $this = $(this);
        $.confirm({
            title: 'تقلبی',
            ...
            autoClose: 'cancel|10000',
            animationSpeed: 600,
            content: 'آیا مطمعن هستید این کارت به کارت تقلبی است؟',
            confirmButtonClass: 'btn-success',
            cancelButtonClass: 'btn-warning',
            contentClass: 'btn-danger',
            confirm: function() {
	...
	$('.cardAccept').on('click', function(e) {
        e.preventDefault();
        $this = $(this);
        $.confirm({
            title: 'تایید',
            ...
            autoClose: 'cancel|10000',
            animationSpeed: 600,
            content: 'شما با تایید این کارت به کارت این تراکنش را تایید میکنید و حساب کاربر ثبت کننده شارژخواهد شد! ادامه میدهید؟',
            confirmButtonClass: 'btn-success',
            cancelButtonClass: 'btn-warning',
            contentClass: 'btn-danger',
            confirm: function() {
