...
class Settings extends Admin_Controller {
    ...
    public function index () {
        ...
        $max_amount_withdraw = Setting::findByCode('max_amount_withdraw');
        $min_amount_withdraw = Setting::findByCode('min_amount_withdraw');
        ...
        $this->smart->assign([
            ...
            'footer' => $footer->value ,
            'max_amount_withdraw' => $max_amount_withdraw->value ,
            'min_amount_withdraw' => $min_amount_withdraw->value ,
        ...
        if ( $this->formValidate(FALSE) ) {
            $data = [
                ...
                'max_amount_withdraw' => $this->input->post('max_amount_withdraw') ,
                'min_amount_withdraw' => $this->input->post('min_amount_withdraw') ,
