...
class Api extends CI_Controller {
    ...
    public function GetUpcomingOdds () {
        ...
        $resultsToday = $this->CI->soccerama->livescore($resultInclude)->today();
		file_put_contents(API_DIR . "home/matches.json" , ($matchesToday));
		file_put_contents(API_DIR . "home/resultsToday.json" , ($resultsToday));
    }
    ...
    public function UpcomingResultToday () {
        ...
        $matches = $this->CI->soccerama->livescore($resultInclude)->today();
    ...
    public function UpcomingResultYesterday () {
        ...
        $matches = $this->CI->soccerama->livescore($resultInclude)->byDate(date('Y-m-d' , strtotime("-1 days")));
        return $this->checkResultUpComing($matches);
    }
    ...
    public function UpcomingResultDayBeforeYesterday () {
        ...
        $matches = $this->CI->soccerama->livescore($resultInclude)->byDate(date('Y-m-d' , strtotime("-2 days")));
        return $this->checkResultUpComing($matches);
    }
