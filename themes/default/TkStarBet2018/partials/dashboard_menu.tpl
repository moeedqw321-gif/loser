			...
			<div class="left static-menu">
				<div class="link-container">
					<div class="desktop">
						...
						<a href="{site_url}payment/cardtocard"{if strpos(getenv('REQUEST_URI'), 'payment/cardtocard') !== false} class="active"{/if}>کارت به کارت ها</a>
					...
					<div class="mobile">
						<select class="selector">
							...
							<option value="{site_url}payment/transactions"{if strpos(getenv('REQUEST_URI'), 'payment/transactions') !== false} selected="selected"{/if}>کارت به کارت ها</option>
							<option value="{site_url}payment/cardtocard"{if strpos(getenv('REQUEST_URI'), 'payment/cardtocard') !== false} selected="selected"{/if}>سابقه تراکنش ها</option>
