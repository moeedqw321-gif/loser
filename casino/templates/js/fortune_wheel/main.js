...
function CTextButton(a, d, b, c, k, e, h, f, l) {
    ...
    this.buttonRelease = function() {
        g || (m.scaleX = 1, m.scaleY = 1, playSound("click", 1, !1), r[ON_MOUSE_UP] && r[ON_MOUSE_UP].call(t[ON_MOUSE_UP]))
    };
...
function CMenu() {
    ...
    this._init = function() {
        ...
        qweqwe = new CTextButton(CANVAS_WIDTH - asdasd.width / 4 - 120, asdasd.height + 53, asdasd, ' ', PRIMARY_FONT, "#ffffff", 40, !0, s_oStage);
        qweqwe.addEventListener(ON_MOUSE_UP, function(){
			window.location = '../../users/casino';
		}, this);
        var n = s_oSpriteLibrary.getSprite("but_play");
        r = new CTextButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT - 190, n, " ", PRIMARY_FONT, "#ffffff", 50, !1, s_oStage);
        r.enable();
        ...
        e = n.height / 2 + 10;
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) m = new CToggle(k, e, n, s_bAudioActive, s_oStage), m.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        n = window.document;
    ...
    this.refreshButtonPos = function(f, g) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || m.setPosition(k - f, g + e);
...
function CGame(a) {
    ...
    this._init = function() {
        ...
        100 !== a ? (a = createBitmap(s_oSpriteLibrary.getSprite("msg_box")), s_oStage.addChild(a), a = new createjs.Text(TEXT_ALERT, "50px " + PRIMARY_FONT, "#ffffff"), a.x = CANVAS_WIDTH / 2, a.y = CANVAS_HEIGHT / 2 - 200, a.textAlign = "center", a.textBaseline = "middle", a.lineWidth = 900, s_oStage.addChild(a)) :
            (d = !0, u = new CWheel(1198, 540), a = createBitmap(s_oSpriteLibrary.getSprite("bg_game")), s_oStage.addChild(a), v = new CLeds(1198, 540), k = v.getState(), q = new CInterface, this._initProbability(), l < START_BET && this.gameOver())
    };
    ...
    this.releaseWheel = function() {
        ...
        0 >= WHEEL_SETTINGS[g].prize ? (e = STATE_LOSE, playSound("game_over", 1, !1)) : (e = STATE_WIN, playSound("win", 1, !1))
    };
...
function CInterface() {
    ...
    this._init = function() {
        ...
        c = p.height / 2 + 10;
        r = new CGfxButton(b, c, p, !0);
        r.addEventListener(ON_MOUSE_UP, this._onExit, this);
        a = CANVAS_WIDTH - p.width / 2 - 100;
        d = p.height / 2 + 10;
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) p = s_oSpriteLibrary.getSprite("audio_icon"), g = new CToggle(a, d, p, s_bAudioActive, s_oStage), g.addEventListener(ON_MOUSE_UP, this._onAudioToggle,
            this);
        p = window.document;
        ...
        t = new CTextButton(500, CANVAS_HEIGHT - 190, p, " ", PRIMARY_FONT, "#ffffff", 50, !1, s_oStage);
        t.enable();
        t.addEventListener(ON_MOUSE_UP, this._onButSpinRelease, this);
        p = s_oSpriteLibrary.getSprite("but_plus");
        m = new CTextButton(650, CANVAS_HEIGHT - 320, p, TEXT_PLUS, PRIMARY_FONT, "#ffffff", 70, !1, s_oStage);
        m.enable();
        m.addEventListener(ON_MOUSE_UP, this._onButPlusRelease, this);
        p = s_oSpriteLibrary.getSprite("but_plus");
        q = new CTextButton(350, CANVAS_HEIGHT - 320, p, TEXT_MIN, PRIMARY_FONT, "#ffffff", 70, !1, s_oStage);
        q.enable();
    ...
    this.disableSpin = function(a) {
        !0 === a ? (t.disable(), m.disable(), q.disable()) : (t.enable(), m.enable(), q.enable())
    };
    this.refreshButtonPos = function(f, t) {
        r.setPosition(b - f, t + c);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || g.setPosition(a - f, t + d);
