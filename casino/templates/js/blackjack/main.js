...
function CTextButton(a, d, b, c, f, e, g, m) {
    ...
    this.buttonRelease = function() {
        n ||
            (playSound("press_but", 1, !1), p.scaleX = 1, p.scaleY = 1, h[ON_MOUSE_UP] && h[ON_MOUSE_UP].call(t[ON_MOUSE_UP]))
    };
...
function CGfxButton(a, d, b) {
    ...
    this.buttonRelease = function() {
        c || (playSound("press_but", 1, !1), h.scaleX = 1, h.scaleY = 1, g[ON_MOUSE_UP] && g[ON_MOUSE_UP].call(m[ON_MOUSE_UP], n))
    };
    this.buttonDown = function() {
...
function CMenu() {
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) l = s_oSpriteLibrary.getSprite("audio_icon"), f = CANVAS_WIDTH - l.width / 4 - 10, e = l.height / 2 + 10, n = new CToggle(f,
    ...
    this.refreshButtonPos =
        function(g, h) {
            !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || n.setPosition(f - g, h + e);
...
function CGame(a) {
    ...
    this._dealing = function() {
        if (p < 2 * B.length) {
            ...
            } else a.setInfo(b, k.getAttachCardOffset(), C[v], s_oGameSettings.getCardValue(C[v]), !1, k.newCardDealed()), G[C[v]] +=
                1, v++;
            y.push(a);
            p++;
    ...
    this.ficheSelected = function(a, b) {
        var c = k.getCurBet();
        a > k.getCredit() ? L.show(TEXT_NO_MONEY) : c + a > n ? L.show(TEXT_ERROR_MAX_BET) : (c = Number((c + a)), k.decreaseCredit(a), K += a, k.changeBet(c), k.refreshFiches(a, b, 0, 0), k.bet(c, !1), x.enable(!0, !1, !1, !1, !1), x.refreshCredit(k.getCredit()))
    };
    this._checkAvailableActionForPlayer = function() {
        ...
        if (21 === a) k.refreshCardValue(), this._passTurnToDealer();
            ...
            var b = !1;
            2 === k.getNumCardsForHand(0) && 8 < k.getHandValue(0) && 16 > k.getHandValue(0) && k.getCredit() >= k.getCurBet() && !c && (b = !0);
            x.enable(!1, !0, !0, b, a);
            11 === A[0].getValue() && k.getCredit() >= k.getCurBet() / 2 && (g = k.getCurBet() / 2, x.showInsurancePanel())
        }
    };
    this._passTurnToDealer = function() {
        b && (b = !1, x.disableButtons(), A[1].showCard(), playSound("card", 1, !1))
    };
    ...
    this.onDeal = function() {
        h > k.getCurBet() ? (L.show(TEXT_ERROR_MIN_BET), s_oInterface.enableBetFiches(), s_oInterface.enable(!0, !1, !1, !1, !1)) : (this.changeState(STATE_GAME_DEALING), $(s_oMain).trigger("bet_placed", k.getCurBet()))
    };
    this.onHit =
        function() {
            var a = new CVector2(I.getX(), I.getY()),
    ...
    this.rebet = function() {
        this.clearBets();
        k.rebet() ? (x.enable(!0, !1, !1, !1, !1), x.refreshCredit(k.getCredit()), m = BET_TIME) : x.disableRebet()
    };
    ...
    this._updateWaitingBet =
        function() {
            m += s_iTimeElaps;
            m > BET_TIME ? (m = 0, k.getCurBet() < h || (x.disableBetFiches(), x.enable(!0, !1, !1, !1, !1), this.changeState(STATE_GAME_DEALING), $(s_oMain).trigger("bet_placed", k.getCurBet()))) : ''
        };
    ...
    this._updateShowWinner = function() {
        ...
        m += s_iTimeElaps;
        m > TIME_END_HAND && (m = 0, this.reset(!1), x.reset(), k.getCredit() < s_oGameSettings.getFichesValueAt(0) ? (this._gameOver(), this.changeState(-1)) : this.changeState(STATE_GAME_WAITING_FOR_BET), x.refreshCredit(k.getCredit()))
    };
...
function CInterface(a) {
    ...
    this._init = function(a) {
        ...
        f = u.height / 2 + 10;
        n = new CGfxButton(c, f, u, !0);
        n.addEventListener(ON_MOUSE_UP, this._onExit, this);
        !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile ? (e = n.getX() - u.width - 10, g = u.height / 2 + 10, w = new CToggle(e, g, s_oSpriteLibrary.getSprite("audio_icon"), s_bAudioActive, s_oStage), w.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this), d = e - u.width - 10, b = g - 4) : (d = n.getX() - u.width, b = u.height / 2);
        u = window.document;
...
function CSeat() {
    ...
    this.checkHand = function() {
        ...
        else if (21 < c) 0 < e[b].getAces() ? (e[b].removeAce(), 21 === e[b].getValue() ? this.checkPlayerLastHand(PASS_TURN) : a ? this.checkPlayerLastHand(PASS_TURN) : B[RESTORE_ACTION] && B[RESTORE_ACTION].call(G[RESTORE_ACTION], !1, !0, !0, !1, !1), this.refreshCardValue()) : 1 < e.length || d ? this.checkPlayerLastHand(PASS_TURN) : this.checkPlayerLastHand(PLAYER_LOSE);
    ...
    this.checkPlayerLastHand = function(a) {
        b--; - 1 < b ? (B[RESTORE_ACTION] && B[RESTORE_ACTION].call(G[RESTORE_ACTION], !1, !0, !0, !1, !1), A.x = w.getX()) : (B[a] && B[a].call(G[a], 0), this.removeArrow())
    };
    ...
    this.showWinner = function(a, b, c, t) {
        0 < c ? (0 === a ? y.text = b + ": " + c : z.text = b + ": " + c, playSound("win", 1, !1)) : (0 === a ? y.text = b : z.text = b, playSound("lose", 1, !1));
    ...
    this.isSplitAvailable = function() {
        return g[0] && g[1] ? 0 === Math.abs(g[0].getFotogram() - g[1].getFotogram()) % 13 ? !0 : !1 : !1
    };
...
function CFichesController(a, d) {
    ...
    this.update = function(a) {
        if (!f)
            if (e += a, e > TIME_FICHES_MOV) e = 0, f = !0, v[FICHES_END_MOV] && v[FICHES_END_MOV].call(w[FICHES_END_MOV], c, g);
            else {
...
function CCard(a, d, b) {
    ...
    this._updateDealing = function() {
        h += s_iTimeElaps;
        if (h > TIME_CARD_DEALING) e = -1, h = 0, l.x = p.getX(), l.y = p.getY(), l.rotation = 360, q[ON_CARD_ANIMATION_ENDING] && q[ON_CARD_ANIMATION_ENDING].call(r[ON_CARD_ANIMATION_ENDING], this, c, n), !1 === (c && 2 === n) && this.showCard();
        else {
            this.visible = !0;
    ...
    this._updateRemoving = function() {
        h += s_iTimeElaps;
        if (h > TIME_CARD_REMOVE) h = 0, f = l.visible = !1, e = -1, q[ON_CARD_TO_REMOVE] && q[ON_CARD_TO_REMOVE].call(r[ON_CARD_TO_REMOVE], this);
        else {
