...
function playSound(a, d, h) {
    return !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile ? (s_aSounds[a].play(), s_aSounds[a].volume(d), s_aSounds[a].loop(h), s_aSounds[a]) : null
}
...
function CMain(a) {
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("hit_area_horizontal",
            self.images_location + "hit_area_horizontal.png");
        ...
        s_oSpriteLibrary.addSprite("chip_box",
            self.images_location + "chip_box.png");
        ...
        s_oSpriteLibrary.addSprite("enlight_horizontal",
            self.images_location + "enlight_horizontal.png");
        ...
        s_oSpriteLibrary.addSprite("circle_green",
            self.images_location + "circle_green.png");
        ...
        s_oSpriteLibrary.addSprite("logo_game_0",
            self.images_location + "logo_game_0.png");
        ...
        for (a = 0; a < NUM_MASK_BALL_SPIN_FRAMES; a++) s_oSpriteLibrary.addSprite("wheel_numbers_" + a, self.images_location + "wheel_anim/wheel_numbers_" +
            a + ".png");
...
function CTextButton(a, d, h, f, b, l, k, g) {
    ...
    this.buttonRelease = function() {
        e || (playSound("click", 1, !1), u.scaleX = 1, u.scaleY = 1, p[ON_MOUSE_UP] && p[ON_MOUSE_UP].call(w[ON_MOUSE_UP], v))
    };
...
function CGfxButton(a, d, h, f) {
    ...
    this.buttonRelease = function() {
        b || (playSound("click", 1, !1), c.scaleX = 1, c.scaleY = 1, g[ON_MOUSE_UP] && g[ON_MOUSE_UP].call(e[ON_MOUSE_UP], n))
    };
    this.buttonDown = function() {
...
function CFicheBut(a, d, h) {
    ...
    this.buttonRelease = function() {
        b || (playSound("click", 1, !1), c.scaleX = 1, c.scaleY = 1, g[ON_MOUSE_UP] && g[ON_MOUSE_UP].call(e[ON_MOUSE_UP], n), f = !f, w.visible = f)
    };
    this.buttonDown = function() {
        b || (c.scaleX = .9, c.scaleY = .9, g[ON_MOUSE_DOWN] && g[ON_MOUSE_DOWN].call(e[ON_MOUSE_DOWN], n))
    };
...
function CBetTextButton(a, d, h, f, b, l, k, g) {
    ...
    this.buttonRelease = function() {
        e || (playSound("click", 1, !1), t.scaleX = 1, t.scaleY = 1, m[ON_MOUSE_UP] && m[ON_MOUSE_UP].call(r[ON_MOUSE_UP], {
            name: u,
            numbers: q,
            bet_mult: p,
            bet_win: w,
...
function CMenu() {
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) m = s_oSpriteLibrary.getSprite("audio_icon"), k = CANVAS_WIDTH - m.width / 4 - 10, g = m.height / 2 + 10, u = new CToggle(k, g, m, s_bAudioActive,
    ...
    this.refreshButtonPos = function(c, h) {
        !1 !== DISABLE_SOUND_MOBILE &&
            !1 !== s_bMobile || u.setPosition(k - c, h + g);
...
function CGame(a) {
    ...
    this.onSpin = function() {
        ...
        0 !== q.getCurBet() && (q.getCurBet() < MIN_BET ? (x.show(TEXT_ERROR_MIN_BET), r.enableBetFiches(), r.enableSpin(!0)) : r.isBlockVisible() || (r.showBlock(), A.hide(), B.hide(), r.enableSpin(!1), jQuery(s_oMain).trigger("bet_placed", q.getCurBet()), this._startRouletteAnim(), this._startBallSpinAnim(), this._setState(STATE_GAME_SPINNING), playSound("wheel_sound", 1, !1)))
    };
    ...
    this._onShowBetOnTableFromNeighbors = function(a, d) {
        ...
        t * h > q.getCredit() ? (x.show(TEXT_ERROR_NO_MONEY_MSG), A.reset()) : (q.createPileForMultipleNumbers(t, a.value, g, f, h), r.setMoney(q.getCredit()), r.setCurBet(q.getCurBet()), r.enableSpin(!0), playSound("chip",
            1, !1))
    };
    ...
    this.onRebet = function() {
        for (var a = 0; a < v.length; a++) !0 === v[a].neighbors ? A.rebet(v[a].num_clicked) : this._onShowBetOnTable(v[a], !0)
    };
...
function CInterface() {
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) y = s_oSpriteLibrary.getSprite("audio_icon"), b = a - y.width / 2, l = y.height / 2 + 10,
    ...
    this.refreshButtonPos = function(g, t) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || n.setPosition(b - g, l + t);
...
function CTableController() {
    ...
    this._init = function() {
        ...
        a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        for (var l = s_oSpriteLibrary.getSprite("hit_area_number"), k = 128, g = 194, e = 1; 37 > e; e++) a = new CBetTableButton(k, g, l, "bet_" + e, d, !1), a.addEventListener(ON_MOUSE_DOWN,
            this._onBetPress, this), !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), 0 === e % 3 ? (k += WIDTH_CELL_NUMBER + 3, g = 194) : g -= HEIGHT_CELL_NUMBER + 3;
        ...
        for (n = 1; 13 > n; n++) a = new CBetTableButton(k, g, l, "bet_" + e + "_" + (e + 1) + "_" + (e + 2), d, !1), a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), k += WIDTH_CELL_NUMBER + 3, e += 3;
        a = new CBetTableButton(96, 232, s_oSpriteLibrary.getSprite("hit_area_small"), "bet_0_1_2_3", d, !1);
        a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER,
            this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        g = k = 158;
        for (n = e = 1; 23 > n; n++) a = new CBetTableButton(k, g, s_oSpriteLibrary.getSprite("hit_area_small"), "bet_" + e + "_" + (e + 1) + "_" + (e + 3) + "_" + (e + 4), d, !1), a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), 0 === n % 2 ? (k += WIDTH_CELL_NUMBER + 3, g = 157, e += 2) : (g -= HEIGHT_CELL_NUMBER + 3, e++);
        k =
            158;
        g = 232;
        e = 1;
        l = s_oSpriteLibrary.getSprite("hit_area_small");
        for (n = 1; 12 > n; n++) a = new CBetTableButton(k, g, l, "bet_" + e + "_" + (e + 1) + "_" + (e + 2) + "_" + (e + 3) + "_" + (e + 4) + "_" + (e + 5), d, !1), a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), e += 3, k += WIDTH_CELL_NUMBER + 3;
    ...
    this._onBetPress = function(a) {
        null !==
            a.numbers && h[ON_SHOW_BET_ON_TABLE] && h[ON_SHOW_BET_ON_TABLE].call(f[ON_SHOW_BET_ON_TABLE], a, !1)
    };
...
function CWheelAnim(a, d) {
    ...
    this._init = function(a, b) {
        ...
        for (var d = 0; d < NUM_MASK_BALL_SPIN_FRAMES; d++) c = createBitmap(s_oSpriteLibrary.getSprite("wheel_numbers_" +
            d)), c.x = 418, c.y = 219, c.visible = !1, x.addChild(c), e.push(c);
        this._initBall();
        n = [];
    ...
    this._ballSpin =
        function() {
            ...
            p.y = c[g].y;
            g++;
            g === NUM_BALL_SPIN_FRAMES ? (h = !1, g = NUM_BALL_SPIN_FRAMES - 1, s_oGame._rouletteAnimEnded(), this.hide()) : g === NUM_BALL_SPIN_FRAMES / 2 && this._showNumberExtracted()
        };
    this.isVisible = function() {
        return x.visible
    };
    this.update = function() {
        !1 !== h && (k++, 2 === k && (k = 0, f && (this._ballSpin(), l === NUM_MASK_BALL_SPIN_FRAMES - 1 ? this.playToFrame(1) : this.nextFrame())))
    };
    this._init(a, d)
}
...
function CFinalBetPanel(a, d) {
    ...
    this._init = function(a, d) {
        ...
        for (var b = s_oSpriteLibrary.getSprite("final_bet_bg"), g = b.width / 2, e = b.height / 2, l = 0; 10 > l; l++) {
            var c = new CTextButton(g, e, b, "" + l, FONT1, "#fff", 14, !1);
...
function CGameOver() {
    ...
    this._init = function() {
        ...
        f = new CTextButton(CANVAS_WIDTH / 2 - 170, 510, s_oSpriteLibrary.getSprite("but_bg"), TEXT_EXIT, FONT1, "#fff", 14, !1);
...
function CRollingTextController(a, d, h, f, b, l, k) {
    ...
    this.update = function() {
        ...
        if (g > e) g = 0, x.text = c + q, null !== z && (z.text = c + q), clearInterval(v), null !== m[ON_CONTROLLER_END] && void 0 !== m[ON_CONTROLLER_END] && m[ON_CONTROLLER_END].call(r[ON_CONTROLLER_END], this), 0 < w ? this.setUpdateInfo(w) : null !== m[ON_CONTROLLER_REMOVE] && void 0 !== m[ON_CONTROLLER_REMOVE] && m[ON_CONTROLLER_REMOVE].call(r[ON_CONTROLLER_REMOVE], this);
            ...
            for (var b = 0; b < t.length; b++) a > t[b].step && !t[b].flag && (t[b].flag = !0, null !== m[ON_CONTROLLER_ROLL] && m[ON_CONTROLLER_ROLL].call(r[ON_CONTROLLER_ROLL], b));
            x.text = a + q;
            null !== z && (z.text = a + q)
        }
    };
