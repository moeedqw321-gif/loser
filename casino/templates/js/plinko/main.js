(function() {
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        g = {
            ...
            on: function(c, b) {
                var h = f[c];
                h && a.addEventListener(h, b, !1)
            },
            off: function(c,
                b) {
                var h = f[c];
                h && a.removeEventListener(h, b, !1)
            },
            raw: d
        };
...
function fadeSound(a, e, b, d) {
    !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || s_aSounds[a].fade(e, b, d)
}
...
function CTextButton(a, e, b, d, f, g, c, h, k) {
    ...
    this.buttonDown = function() {
        m || (q.scaleX = .9, q.scaleY = .9, playSound("click", 1, !1), l[ON_MOUSE_DOWN] && l[ON_MOUSE_DOWN].call(n[ON_MOUSE_DOWN]))
    };
...
function CGfxButton(a, e, b, d) {
    ...
    this.buttonDown = function() {
        f || (m.scaleX = .9 * g, m.scaleY = .9 * g, playSound("click",
            1, !1), c[ON_MOUSE_DOWN] && c[ON_MOUSE_DOWN].call(h[ON_MOUSE_DOWN], k))
    };
    this.buttonOver = function(a) {
...
function CMenu() {
    ...
    this._init = function() {
        ...
        qwe = new CTextButton(CANVAS_WIDTH - asd.width / 4 - 160, 275, asd, ' ', PRIMARY_FONT, "#ffffff", 40, !0, s_oStage);
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) p = s_oSpriteLibrary.getSprite("audio_icon"), a = CANVAS_WIDTH - p.width / 4 - 10, e = p.height / 2 + 10, h = new CToggle(a, e, p, s_bAudioActive, s_oStage), h.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        p = window.document;
    ...
    this.refreshButtonPos = function(c, f) {
        ...
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || h.setPosition(a - c, f + e);
...
function CGame(a) {
    ...
    this.getFallPath = function() {
        ...
        for (var b = 0; b < a.length; b++) u[a[b].row][a[b].col].highlight(!0);
        a = this.getPathCopy(a);
        x.startPathAnim(a, 500);
        x = null
    };
    this.ballArrived = function(a) {
        PRIZE[a] * b >= d ? playSound("ball_in_basket", 1, !1) : playSound("ball_in_basket_negative", 1, !1);
...
function CInterface(a) {
    ...
    this._init = function(a) {
        ...
        d = y = g - r.width - 10;
        f = r.height / 2 + 10;
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) r = s_oSpriteLibrary.getSprite("audio_icon"), h = new CToggle(d, f, r, s_bAudioActive, s_oStage), h.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this), y = d - r.width / 2 - 10;
        r = window.document;
        v = r.documentElement;
        ...
        p = new CTextButton(160, 0, r, TEXT_PLUS, PRIMARY_FONT, "#0083ea", 80, !1, y);
        p.enable();
        p.addEventListener(ON_MOUSE_UP, this._onButPlusRelease, this);
        p.setTextPosition(1, 26);
        p.hideShadow();
        r = s_oSpriteLibrary.getSprite("but_min");
        t = new CTextButton(-160, 0, r, TEXT_MIN, PRIMARY_FONT, "#0083ea", 80, !1, y);
        t.enable();
...
function CGridMapping(a) {
    ...
    this.getAllPathFromTo = function(a, b) {
        for (var c = s_oGridMapping.getAllPathFrom(a), d = c.length - 1; 0 <= d; d--) {
            for (var e = !1, h = 0; h < c[d].length; h++)
...
function CSlot(a, e, b, d, f) {
    ...
    this.buttonDown = function() {
        g ||
            (l.scaleX = .9 * c, l.scaleY = .9 * c, playSound("click", 1, !1), h[ON_MOUSE_DOWN] && h[ON_MOUSE_DOWN].call(k[ON_MOUSE_DOWN], m))
    };
    this.buttonOver = function(a) {
...
function CGUIExpandible(a, e, b, d) {
    ...
    this._expand = function() {
        for (var a = 0; a < h.length; a++) h[a].visible = !0, createjs.Tween.get(h[a], {
            override: !0
        }).wait(300 * a / 2).to({
            y: f + a * g
